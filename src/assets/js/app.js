/*!
 * geekskare: Front-end site library
 * @license MIT
 * Inline scripts may access the api using an async handler:
 *   var geekskare = geekskare || [];
 *   geekskare.push(readyFunction);
 */
! function (t) {
    var e = {};
    ...
    d.config.hideBackface = !1, d.config.keepInherited = !0, r.define = function (t, e, n) {
        ...
        var e = window.__wf_design,
            n = void 0 !== e;
        return t ? "design" === t ? n && e : "preview" === t ? n && !e : "slug" === t ? n && window.__wf_slug : "editor" === t ? window.geekskareEditor : "test" === t ? window.__wf_test : "frame" === t ? window !== window.top : void 0 : n
    };
    ...
    var b, w = "resize.geekskare orientationchange.geekskare load.geekskare";
    ...
    r.resize = T(c, w), r.scroll = T(c, "scroll.geekskare resize.geekskare orientationchange.geekskare load.geekskare"), r.redraw = T(), r.location = function (t) {
        window.location = t
    ...
    }, u(r.ready), A(), t.exports = window.geekskare = r
}, function (t, e, n) {
    "use strict";
    var r = n(14);
    ...
    r.define("brand", t.exports = function (t) {
        ...
        return n.ready = function () {
            ...
            /\.geekskare\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t('<a class="w-geekskare-badge"></a>').attr("href", "https://geekskare.com?utm_campaign=brandjs"), r = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/geekskare-badge-icon.f67cd735e3.svg").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
            }), a = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/geekskare-badge-text.6faa6a38cd.svg").attr("alt", "Made in geekskare"), n.append(r, a), n[0]), d(), setTimeout(d, 500), t(i).off(l, f).on(l, f))
        }, n
    })
}, function (t, e, n) {
    "use strict";
    var r = window.$,
        i = n(65) && r.tram;
    /*!
     * geekskare._ (aka) Underscore.js 1.6.0 (custom build)
     * _.each
     * _.map
     * _.find
     * _.filter
    ...
    r.define("edit", t.exports = function (t, e, n) {
        ...
        var i, o = t(window),
            ...
            c = "hashchange",
            s = n.load || function () {
                i = !0, window.geekskareEditor = !0, o.off(c, f),
                    function (t) {
                        var e = window.document.createElement("iframe");
                        e.src = "https://geekskare.com/site/third-party-cookie-check.html", e.style.display = "none", e.sandbox = "allow-scripts allow-same-origin";
                        var n = function n(r) {
                        ...
                        t.ajax({
                            url: g("https://editor-api.geekskare.com/api/editor/view"),
                            data: {
            ...
            l = !1;
        try {
            l = localStorage && localStorage.getItem && localStorage.getItem("geekskareEditor")
        } catch (t) { }
        ...
        function h(t) {
            return t.indexOf("//") >= 0 ? t : g("https://editor-api.geekskare.com" + t)
        }
    ...
    e.createPluginInstance = function (t) {
        var e = window.geekskare.require("lottie").createInstance(t);
    ...
    e.clearPlugin = function (t) {
        window.geekskare.require("lottie").createInstance(t).stop()
    }
}, function (t, e, n) {
    "use strict";
    var r, i, o, a = n(0),
    ...
    function mt(t) {
        ...
        return null == C || null == N ? [] : m.IS_BROWSER_ENV && u ? d(N).filter(function (t) {
            return u.contains(t)
        }) : R === k ? d(C, N) : R === F ? p(d(C)).filter(g(N)) : R === G ? v(d(C)).filter(g(N)) : d(N)
    }
    var yt = /px/,
        _t = function (t, e) {
    ...
    var c, s, l, f = u(n(28)),
        ...
        }), (0, o.default)(r, j, gt), (0, o.default)(r, k, gt), (0, o.default)(r, M, (0, f.default)({}, ot, {
    ...
    i.define("forms", t.exports = function (t, e) {
        ...
        return s.ready = s.design = s.preview = function () {
            ! function () {
                o = t("html").attr("data-wf-site"), u = "https://geekskare.com/api/v1/form/" + o, d && u.indexOf("https://geekskare.com") >= 0 && (u = u.replace("https://geekskare.com", "http://formdata.geekskare.com"));
    ...
    r.define("lightbox", t.exports = function (t) {
        ...
        return i.ready = i.design = i.preview = function () {
            e = o && r.env("design"), a.destroy(), n = {}, u.find(c).geekskareLightBox()
        }, jQuery.fn.extend({
            geekskareLightBox: function () {
        ...
        function A(n, r) {
            ...
            s && "/" === s.attr("href") && null == s.attr("aria-label") && s.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(g), a.button.off(g), a.menu.off(g), R(a), u ? (S(a), a.el.on("setting" + g, function (t) {
                return function (n, r) {
                    r = r || {};
                    var i = f.width();
                    R(t), !0 === r.open && G(t, !0), !1 === r.open && U(t, !0), t.open && e.defer(function () {
                        i !== f.width() && N(t)
                    })
                }
            }(a))) : (! function (e) {
        ...
        function C(n) {
            return function (i, a) {
                ...
                if (u && "setting" === i.type) {
                    ...
                    ! function (n, r) {
                        var i = null;
                        r === n.slides.length && (m(), P(n)), e.each(n.anchors, function (e, n) {
...
/**
 * ----------------------------------------------------------------------
 * geekskare: Interactions 2.0: Init
 */
geekskare.require('ix2').init({
    "events": {
        "e": {
            "id": "e",
            "name": "",
            ...
            "target": {
                ...
                "originalId": "5f5c81d620e39d01745ac15e|9836ec04-8df9-f616-d85d-331fe4830be2",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".faq-question",
        ...
        "e-3": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5f5c81d620e39da8435ac1ce|4bb2a15b-0c24-8de2-c710-44f883c5e345",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-5": {
            ...
            "target": {
                ...
                "originalId": "5f5c81d620e39da8435ac1ce|03662392-1572-39e9-8a43-e11f74dc561d",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".image-element",
        ...
        "e-7": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5f5c81d620e39da8435ac1ce|4bb2a15b-0c24-8de2-c710-44f883c5e347",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-9": {
            ...
            "target": {
                "selector": ".close",
                "originalId": "5f5c81d620e39da8435ac1ce|f0233175-7247-e783-1a81-e13a5b596c62",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".close",
        ...
        "e-11": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5f5c81d620e39da8435ac1ce|a0658c32-d96d-b326-1849-bb33296c5c74",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-13": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5f5c81d620e39da8435ac1ce|abe6b9d8-0216-d3a3-a17d-ebea0744483c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-15": {
            ...
            "target": {
                "selector": ".team-top",
                "originalId": "5f5c81d620e39de3045ac13b|988aa803-ad2f-c62b-9860-0f37f6e26292",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".team-top",
        ...
        "e-17": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5f5c81d620e39d3e325ac1d0|ab07a7d2-53b3-e71f-a7fb-5dd143de4c06",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-19": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".pricing-box",
                "originalId": "5f5c81d620e39d25895ac1d2|27e68f7d-7291-ea1b-9a77-11fc9c17ffb5",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".pricing-box",
        ...
        "e-21": {
            ...
            "target": {
                "selector": ".step",
                "originalId": "5f5c81d620e39d4a495ac1d3|7f175439-5436-a7ea-7435-d82a077c4901",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".step",
        ...
        "e-23": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".blog-box-image",
                "originalId": "5f5c81d620e39d4ea65ac133|fef87e6f-1c9e-77e0-a6b1-b2b5ff87bae5",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".blog-box-image",
        ...
        "e-25": {
            ...
            "target": {
                ...
                "originalId": "5f5c81d620e39dcbbf5ac142|a2c2f436-8edf-6329-6763-1c1d851693eb",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".lightbox-link",
        ...
        "e-27": {
            ...
            "target": {
                ...
                "originalId": "5f5c81d620e39dcbbf5ac142|fae3aff6-e1b5-e16e-21a2-f16dc7496034",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".border-lightbox",
        ...
        "e-29": {
            ...
            "target": {
                ...
                "originalId": "5f5c81d620e39d12305ac12f|64acf5f7-3ea5-400e-d93f-f7815e7252e1",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".arrow-button",
        ...
        "e-31": {
            ...
            "target": {
                ...
                "originalId": "5f5c81d620e39d1fea5ac123|b22fcfb9-8510-cf86-42e4-d0f97072e407",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".navigation-link",
    ...
    "actionLists": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".faq-answer",
                            "selectorGuids": ["1eb7f845-0173-401a-a4e3-6a1f3fdcc03e"]
                        },
                        "value": "none"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["2621b55c-0f8e-8fcc-ad93-3194b6ca52da"]
                        },
                        "zValue": 0,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "selector": ".popup-bg.simple",
                            "selectorGuids": ["b80ce5b1-0152-7b31-d8ed-3fb8db929231", "4ff6dc71-a5e5-1ec4-f8ed-52e3c77a8402"]
                        },
                        "value": "none"
                    }
                }]
        ...
        "a-4": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "selector": ".popup-bg",
                            "selectorGuids": ["b80ce5b1-0152-7b31-d8ed-3fb8db929231"]
                        },
                        "value": "none"
                    }
                }]
            ...
            "useFirstGroupAsInitialState": false,
            "createdOn": 1597749105079
        },
        "a-5": {
            "id": "a-5",
            "title": "Two Step Popup Open",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-5-n",
                    "actionTypeId": "GENERAL_DISPLAY",
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "selector": ".popup-bg.two",
                            "selectorGuids": ["b80ce5b1-0152-7b31-d8ed-3fb8db929231", "a296afbd-d890-7249-63af-c8cfd92e036b"]
                        },
                        "value": "none"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "selector": ".popup-box.one",
                            "selectorGuids": ["2fe072c2-6b4e-52a0-074e-4909f4944bbd", "549908f8-8d18-6a1f-f796-b31a39a15ab6"]
                        },
                        "value": "none"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "selector": ".popup-box.two",
                            "selectorGuids": ["2fe072c2-6b4e-52a0-074e-4909f4944bbd", "f3747133-5833-620e-14d7-256c156d002a"]
                        },
                        "value": "none"
                    }
                }]
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".team-social-div",
                            "selectorGuids": ["afefd738-dd0d-ca27-4ad9-910d955bf736"]
                        },
                        "value": 0,
                        "unit": ""
                    }
        ...
        "a-10": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["81b4a64d-945e-2304-0efb-6935b95c8663"]
                        },
                        "value": 1,
                        "unit": ""
                    }
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1597755278227
        },
        "a-11": {
            "id": "a-11",
            "title": "Pricing Box Hover",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-11-n-2",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "5f5c81d620e39d25895ac1d2|27e68f7d-7291-ea1b-9a77-11fc9c17ffb5"
                        },
                        "globalSwatchId": "50a42539",
                        "rValue": 240,
                        "bValue": 245,
                        "gValue": 244,
                        "aValue": 1
            ...
            "useFirstGroupAsInitialState": false,
            "createdOn": 1597766015246
        },
        "a-12": {
            "id": "a-12",
            "title": "Pricing Box Hover Out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-12-n-2",
                    "actionTypeId": "STYLE_BACKGROUND_COLOR",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "SIBLINGS",
                            "selector": ".pricing-box",
                            "selectorGuids": ["41e4d395-b61f-0fdc-60b6-00fb7a0041c6"]
                        },
                        "globalSwatchId": "",
                        "rValue": 240,
                        "bValue": 245,
        ...
        "a-13": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".step-inner-circle",
                            "selectorGuids": ["bb879c5f-a070-24df-c537-c06bb3e013c6"]
                        },
                        "globalSwatchId": "",
                        "rValue": 68,
                        "bValue": 246,
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".step-circle",
                            "selectorGuids": ["b052043d-98e9-d518-bf30-f1621c546e1b"]
                        },
                        "globalSwatchId": "",
                        "rValue": 68,
                        "bValue": 246,
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1597955335004
        },
        "a-14": {
            "id": "a-14",
            "title": "Circle Hover Out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-14-n-3",
                    "actionTypeId": "STYLE_BORDER",
        ...
        "a-15": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "PARENT",
                            "selector": ".blog-box-item",
                            "selectorGuids": ["36147c4d-c17c-7b9a-9686-31d556824493"]
                        },
                        "yValue": 0,
                        "xUnit": "PX",
                        "yUnit": "PX",
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1597998508151
        },
        "a-16": {
            "id": "a-16",
            "title": "Blog Box Hover Out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-16-n-2",
                    "actionTypeId": "TRANSFORM_MOVE",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".lightbox-play.normal",
                            "selectorGuids": ["9ac11540-a700-5ad8-feab-765c3d3befd9", "c78cca72-7747-0693-97b0-b742b7339833"]
                        },
                        "xValue": 1,
                        "yValue": 1,
                        "locked": true
        ...
        "a-19": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".play-border",
                            "selectorGuids": ["264b3665-0dd5-5235-70bb-755829ef0331"]
                        },
                        "globalSwatchId": "dc6d3168",
                        "rValue": 255,
                        "bValue": 255,
                        "gValue": 255,
                        "aValue": 1
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1597999797165
        },
        "a-20": {
            "id": "a-20",
            "title": "Video Border Hover Out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-20-n-2",
                    "actionTypeId": "STYLE_BORDER",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["f6d480ba-b51a-2de7-5451-3cfac141ca06"]
                        },
                        "xValue": 0,
                        "xUnit": "PX",
                        "yUnit": "PX",
        ...
        "a-25": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".grey-description",
                            "selectorGuids": ["41b1a6a2-49b6-1773-f5fd-96a66cde99cc"]
                        },
                        "globalSwatchId": "",
                        "rValue": 140,
                        "bValue": 180,
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1598008336187
        },
        "a-26": {
            "id": "a-26",
            "title": "Navigation Link Hover Out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-26-n-2",
                    "actionTypeId": "STYLE_TEXT_COLOR",
